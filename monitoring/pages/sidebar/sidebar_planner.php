...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="job_plan.php">
              <span class="menu-icon">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="session/machine_session.php">
              <span class="menu-icon">
                <i class="mdi mdi-collage"></i>
              </span>
              <span class="menu-title">Machine Option</span>
            </a>
          </li>
          <li class="nav-item menu-items">
